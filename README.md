...
| Everything ISO | x86_64 | 1.1GB | [xiboplayer-kiosk-everything_x86_64.iso](https://images.xiboplayer.org/xiboplayer-kiosk/0.0.0-dev/xiboplayer-kiosk-everything_0.0.0-dev_x86_64.iso) | Offline install on PCs, NUCs, signage boxes. No internet needed — all packages bundled. Flash to USB, boot, walk away. |
| Everything ISO | aarch64 | 1.2GB | [xiboplayer-kiosk-everything_aarch64.iso](https://images.xiboplayer.org/xiboplayer-kiosk/0.0.0-dev/xiboplayer-kiosk-everything_0.0.0-dev_aarch64.iso) | Offline install on Raspberry Pi 5, ARM servers. |
| Netinstall ISO | x86_64 | 1.1GB | [xiboplayer-kiosk-netinstall_x86_64.iso](https://images.xiboplayer.org/xiboplayer-kiosk/0.0.0-dev/xiboplayer-kiosk-netinstall_0.0.0-dev_x86_64.iso) | Lightweight installer, downloads from Fedora mirrors. Always gets latest packages. |
| Netinstall ISO | aarch64 | 1.1GB | [xiboplayer-kiosk-netinstall_aarch64.iso](https://images.xiboplayer.org/xiboplayer-kiosk/0.0.0-dev/xiboplayer-kiosk-netinstall_0.0.0-dev_aarch64.iso) | Same for ARM64. Raspberry Pi 5 network install. |
| **Disk images (ready to boot, no installer)** | | | | |
| QCOW2 | x86_64 | 1.7GB | [xiboplayer-kiosk_x86_64.qcow2](https://images.xiboplayer.org/xiboplayer-kiosk/0.0.0-dev/xiboplayer-kiosk_0.0.0-dev_x86_64.qcow2) | Virtual machines (QEMU/KVM, Proxmox, Gnome Boxes). Import and boot — no installation step. |
| QCOW2 | aarch64 | ~1.7GB | [xiboplayer-kiosk_aarch64.qcow2](https://images.xiboplayer.org/xiboplayer-kiosk/0.0.0-dev/xiboplayer-kiosk_0.0.0-dev_aarch64.qcow2) | ARM64 virtual machines. |
